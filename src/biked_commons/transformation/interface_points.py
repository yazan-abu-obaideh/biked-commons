...
def calculate_interace_points_df(df):
    columns = ["Components/General_Handlebar_from_BB_(X)","Components/General_Handlebar_from_BB_(Y)","Components/Handlebar_Style","Components/Handlebar_A","Components/Handlebar_B","Components/Handlebar_C","Components/Handlebar_angle",
